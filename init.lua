...
What is Kickstart?
  ...
  Kickstart.nvim is a starting point for your own configuration.
    ...
    make Neovim your own! That mum
enchant    gnome-control-center      goa-1.0        ibus           nvim          Postman        user-dirs.dirs    wezteright mean leaving Kickstart just the way it is for a while
    or immediately breaking it into modular pieces.ca7dd9a7eec47d02fda02a0253fa53cf4b424c13 It's up to you!
    ...
    - :help lua-guide
    - (or HTML version): https://neovim.io/doc/userca7dd9a7eec47d02fda02a0253fa53cf4b424c13/lua-guide.html
...
enchant    gnome-control-center      goa-1.0        ibus           nvim          Postman        user-dirs.dirs    wezter should do is to run the command `:Tutor` in Neovim.
  ...
  Once you've completed that, you can continue workca7dd9a7eec47d02fda02a0253fa53cf4b424c13ing through **AND READING** the rest
  of the kickstart init.lua.

  Next, run AND READ `:help`.
    This will open up a help window with some basicca7dd9a7eec47d02fda02a0253fa53cf4b424c13 information
